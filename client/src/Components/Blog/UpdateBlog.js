    ...
    try {
      ...
      if (title.trim() !== "" && description.trim() !== "") {
        if (img) {
          ...
          setErrorMsg("");
          // await axios.put(`${url}/blog/update/${blogId}`, formData, {
          //   headers: {
...
// const UpdateBlog = () => {
//   const { stateupdate } = useLocation();
//   const { blog } = stateupdate;
...
//   return (
//     <div className="container" style={{ minHeight: "75vh" }}>
//       <h2 className="my-4">Update Your Blog</h2>
//       <Form className="search-form" onSubmit={handleOnSubmit}>
//         {errorMsg && <Alert variant="danger">{errorMsg}</Alert>}
//         <Form.Group as={Row} controlId="title">
//           <Form.Label column sm={2}>
...
//                 src={previewSrc}
//                 alt="Preview"
//                 style={{ height: "20vh", marginTop: "7px" }}
//               />
//             </div>
//           )}
//         </div>
...
//           <Link to="/bloglist" style={{ color: "white" }}>
//             See Blogs
//           </Link>
//         </Button>
//       </Form>
